...
<link rel="stylesheet" href="/WebClass2/css/signin.css">
</head>
<body>
<div class="container">
...
<%UserVo user = (UserVo)session.getAttribute("user"); %>
  ...
  <form id="signupForm" class="form-signin" action="/WebClass2/signup" method="post">
           ...
           "nickname" : nickname
        	   ...
        	   var obj = eval("("+data+")");
         	   if(obj.flag) {
         		  ...
         		  window.location.href="/WebClass/login.jsp";
         	   }
         	   else {
					console.log(data);
